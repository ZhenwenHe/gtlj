 ...
 */
package gtl.jts.operation.buffer;

import gtl.jts.algorithm.Angle;
import gtl.jts.algorithm.CGAlgorithms;
import gtl.jts.algorithm.HCoordinate;
import gtl.jts.algorithm.LineIntersector;
import gtl.jts.algorithm.NotRepresentableException;
import gtl.jts.algorithm.RobustLineIntersector;
import gtl.jts.geom.Coordinate;
import gtl.jts.geom.LineSegment;
import gtl.jts.geom.PrecisionModel;
import gtl.jts.geomgraph.Position;
