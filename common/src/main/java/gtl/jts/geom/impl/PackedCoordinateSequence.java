    ...
    implements CoordinateSequence
{
  ...
  /**
   * @see gtl.jts.geom.CoordinateSequence#getDimension()
   */
  ...
  /**
   * @see gtl.jts.geom.CoordinateSequence#getCoordinate(int)
   */
  ...
  /**
   * @see gtl.jts.geom.CoordinateSequence#toCoordinateArray()
   */
...
// testing - never cache
  ...
  /**
   * @see gtl.jts.geom.CoordinateSequence#getX(int)
   */
  ...
  /**
   * @see gtl.jts.geom.CoordinateSequence#getY(int)
   */
  ...
  /**
   * @see gtl.jts.geom.CoordinateSequence#getOrdinate(int, int)
   */
  ...
  public static class Double extends PackedCoordinateSequence {
    ...
    /**
     * @see gtl.jts.geom.CoordinateSequence#size()
     */
    public int size() {
    ...
    /**
     * @see gtl.jts.geom.PackedCoordinateSequence#setOrdinate(int,
     *      int, double)
     */
