    ...
    CoordinateSequenceFactory
{
  ...
  /**
   * @see gtl.jts.geom.CoordinateSequenceFactory#create(gtl.jts.geom.Coordinate[])
   */
  ...
  /**
   * @see gtl.jts.geom.CoordinateSequenceFactory#create(gtl.jts.geom.CoordinateSequence)
   */
  ...
  /**
   * @see gtl.jts.geom.CoordinateSequenceFactory#create(double[],
   *      int)
   */
  ...
  /**
   * @see gtl.jts.geom.CoordinateSequenceFactory#create(float[],
   *      int)
   */
  ...
  /**
   * @see gtl.jts.geom.CoordinateSequenceFactory#create(int, int)
   */
