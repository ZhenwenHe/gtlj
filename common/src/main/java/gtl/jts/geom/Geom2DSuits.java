...
import gtl.geom.VertexSequence;
import gtl.geom.LineString;
import gtl.jts.JTSWrapper;
import gtl.jts.algorithm.CGAlgorithms;
import gtl.jts.algorithm.RayCrossingCounter;
...
public class Geom2DSuits extends GeomSuits {
     ...
     */
    public static boolean pointInLineSegment(Vector2D P, gtl.geom.LineSegment S) {
     ...
     */
    public static int intersection(gtl.geom.LineSegment S1, gtl.geom.LineSegment S2, Vector2D outPoint0, Vector2D outPoint1) {
     ...
     * @return
     */
    public static boolean intersects(gtl.geom.Envelope e2d, gtl.geom.Triangle t){
     ...
     * @return
     */
    public static boolean intersects(gtl.geom.Triangle root, gtl.geom.Triangle sub){
     ...
     * @return
     */
    public static boolean contains(gtl.geom.Triangle root, gtl.geom.Triangle sub){
        return JTSWrapper.toJTSGeometry(root).intersects(JTSWrapper.toJTSGeometry(sub));
    }
     ...
     * @return
     */
    public static boolean contains(gtl.geom.Envelope e2d, gtl.geom.Triangle t){
        return JTSWrapper.toJTSGeometry(e2d).contains(JTSWrapper.toJTSGeometry(t));
    }

    public static boolean contains(gtl.geom.Triangle t, double x, double y){
     ...
     * @return
     */
    public static boolean contains(gtl.geom.Triangle t, gtl.geom.Envelope e2d){
     ...
     * @return
     */
    public static boolean intersects(gtl.geom.Triangle t, gtl.geom.LineSegment ls){
     ...
     * @return
     */
    public static boolean intersects(gtl.geom.Triangle t, LineString ls){
        return JTSWrapper.toJTSGeometry(t).intersects(JTSWrapper.toJTSGeometry(ls));
    }
     ...
     * @return
     */
    public static Collection<gtl.geom.Envelope> createVoronoiPartitioning(List<Envelope> samples, int partitions){
