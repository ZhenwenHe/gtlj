...
import gtl.jts.algorithm.*;
import gtl.jts.geom.util.*;
import gtl.jts.io.WKTWriter;
import gtl.jts.operation.*;
import gtl.jts.operation.buffer.BufferOp;
import gtl.jts.operation.distance.DistanceOp;
import gtl.jts.operation.linemerge.LineMerger;
import gtl.jts.operation.overlay.OverlayOp;
import gtl.jts.operation.union.UnaryUnionOp;
import gtl.jts.operation.overlay.snap.SnapIfNeededOverlayOp;
import gtl.jts.operation.predicate.RectangleIntersects;
import gtl.jts.operation.predicate.RectangleContains;
import gtl.jts.operation.relate.RelateOp;
import gtl.jts.operation.valid.IsValidOp;
import gtl.jts.util.Assert;
...
//      return other.intersection(this);
  ...
  protected void checkNotGeometryCollection(Geometry g) {
    ...
    if (g.getClass().getName().equals("gtl.jts.geom.GeometryCollection")) {
  ...
  {
    return getClass().equals(gtl.jts.geom.GeometryCollection.class);
  }
