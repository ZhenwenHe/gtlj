 ...
 */
package gtl.jts.precision;

import gtl.jts.algorithm.CGAlgorithms;
import gtl.jts.geom.*;
import gtl.jts.geom.Geometry;
import gtl.jts.geom.LineSegment;
import gtl.jts.geom.LineString;
import gtl.jts.geom.Lineal;
import gtl.jts.geom.Point;
import gtl.jts.index.strtree.ItemBoundable;
import gtl.jts.index.strtree.ItemDistance;
import gtl.jts.index.strtree.STRtree;
import gtl.jts.operation.distance.FacetSequence;
import gtl.jts.operation.distance.FacetSequenceTreeBuilder;
