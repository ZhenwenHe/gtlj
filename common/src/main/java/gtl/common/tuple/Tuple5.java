...
public class Tuple5<T0, T1, T2, T3, T4> extends Tuple {
	...
	public void copyFrom(Object i) {
		Tuple5<T0,T1,T2,T3,T4> t = (Tuple5<T0,T1,T2,T3,T4>)i;
		this.f0 = t.f0;
		this.f1 = t.f1;
		this.f2 = t.f2;
		this.f3 = t.f3;
	...
	public boolean load(DataInput in) throws IOException {
		...
		try {
			...
			this.f0= (T0) ois.readObject();
			this.f1= (T1) ois.readObject();
			this.f2= (T2) ois.readObject();
			this.f3= (T3) ois.readObject();
			this.f4=(T4)ois.readObject();
			ois.close();
		}
	...
	public boolean store(DataOutput out) throws IOException {
		try {
			...
			oos.writeObject(this.f0);
			oos.writeObject(this.f1);
			oos.writeObject(this.f2);
			oos.writeObject(this.f3);
			oos.writeObject(this.f4);
