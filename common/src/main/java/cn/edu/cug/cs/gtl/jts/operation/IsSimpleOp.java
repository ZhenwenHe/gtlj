 ...
 */
package cn.edu.cug.cs.gtl.jts.operation;
...
import cn.edu.cug.cs.gtl.jts.geomgraph.EdgeIntersection;
import cn.edu.cug.cs.gtl.jts.geomgraph.GeometryGraph;
import cn.edu.cug.cs.gtl.jts.geom.util.LinearComponentExtracter;
...
public class IsSimpleOp {
    ...
    /**
     * Add an endpoint to the scene, creating an entry for it if none exists
     */
