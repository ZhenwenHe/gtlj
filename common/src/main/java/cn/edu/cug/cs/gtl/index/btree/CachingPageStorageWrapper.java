...
public class CachingPageStorageWrapper extends CachingPageStorage {
    ...
    /**
     * underlying PageStorage
     */
    private final PageStorage ps;
    /**
     * all CachedPage instances, even evicted
     */
    private final WeakHashMap<Integer, CachedPageImpl> allCachedPages = new WeakHashMap<Integer, CachedPageImpl>();
    /**
     * non-evicted CachedPage instances
     */
    ...
    public int createPage() {
        return ps.createPage();
    }

    public int getNumPages() {
        return ps.getNumPages();
    }
