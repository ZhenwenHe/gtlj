...
import cn.edu.cug.cs.gtl.jts.algorithm.*;
import cn.edu.cug.cs.gtl.jts.geom.util.GeometryCollectionMapper;
import cn.edu.cug.cs.gtl.jts.geom.util.GeometryMapper;
import cn.edu.cug.cs.gtl.jts.io.WKTWriter;
import cn.edu.cug.cs.gtl.jts.operation.IsSimpleOp;
import cn.edu.cug.cs.gtl.jts.operation.buffer.BufferOp;
import cn.edu.cug.cs.gtl.jts.operation.distance.DistanceOp;
import cn.edu.cug.cs.gtl.jts.operation.linemerge.LineMerger;
import cn.edu.cug.cs.gtl.jts.operation.overlay.OverlayOp;
import cn.edu.cug.cs.gtl.jts.operation.overlay.snap.SnapIfNeededOverlayOp;
import cn.edu.cug.cs.gtl.jts.operation.predicate.RectangleContains;
import cn.edu.cug.cs.gtl.jts.operation.predicate.RectangleIntersects;
import cn.edu.cug.cs.gtl.jts.operation.relate.RelateOp;
import cn.edu.cug.cs.gtl.jts.operation.union.UnaryUnionOp;
import cn.edu.cug.cs.gtl.jts.operation.valid.IsValidOp;
import cn.edu.cug.cs.gtl.jts.util.Assert;
...
public abstract class Geometry
    ...
    */
     ...
     *
     * @param distance         the width of the buffer (may be positive, negative or 0)
     * @param quadrantSegments the number of line segments used to represent a quadrant of a
     *                         circle
     * @return a polygonal geometry representing the buffer region (which may be
     * empty)
     * @throws TopologyException if a robustness error occurs
...
//      return other.intersection(this);
    ...
    protected void checkNotGeometryCollection(Geometry g) {
        ...
        if (g.getClass().getName().equals("GeometryCollection")) {
