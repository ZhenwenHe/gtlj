...
package cn.edu.cug.cs.gtl.jts.triangulate;
...
import cn.edu.cug.cs.gtl.jts.triangulate.quadedge.LastFoundQuadEdgeLocator;
import cn.edu.cug.cs.gtl.jts.triangulate.quadedge.QuadEdgeSubdivision;
import cn.edu.cug.cs.gtl.jts.triangulate.quadedge.Vertex;
import cn.edu.cug.cs.gtl.jts.util.Debug;
import cn.edu.cug.cs.gtl.jts.algorithm.ConvexHull;
...
import cn.edu.cug.cs.gtl.jts.util.Debug;
import cn.edu.cug.cs.gtl.jts.index.kdtree.KdNode;
import cn.edu.cug.cs.gtl.jts.index.kdtree.KdTree;
import cn.edu.cug.cs.gtl.jts.triangulate.quadedge.LastFoundQuadEdgeLocator;
import cn.edu.cug.cs.gtl.jts.triangulate.quadedge.QuadEdgeSubdivision;
import cn.edu.cug.cs.gtl.jts.triangulate.quadedge.Vertex;
...
public class ConformingDelaunayTriangulator {
     ...
     * segments.get(i); QuadEdge q = subdiv.locate(s.getStart(), s.getdEnd()); if
