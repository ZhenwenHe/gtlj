...
package cn.edu.cug.cs.gtl.jts.simplify;

import java.util.*;

import cn.edu.cug.cs.gtl.jts.geom.*;
import cn.edu.cug.cs.gtl.jts.geom.util.GeometryTransformer;
...
public class TopologyPreservingSimplifier {
    ...
    /**
     * A filter to add linear geometries to the linestring scene
