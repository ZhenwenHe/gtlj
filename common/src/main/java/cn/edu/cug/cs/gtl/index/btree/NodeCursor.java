...
import cn.edu.cug.cs.gtl.index.btree.CachingPageStorage.CachedPage;
...
abstract class NodeCursor
    ...
    public abstract void initBuf(CachingPageStorage.CachedPage cp, boolean isRightMost);
    ...
    public boolean isRightMost() {
        return bt.ui.deserializeInt(getBuf(), 0 * SIZEOF_INT) != 0;
    }

    protected void setRightMost(boolean r) {
        bt.ui.serializeInt(r ? 1 : 0, getBuf(), 0 * SIZEOF_INT);
    }
}
