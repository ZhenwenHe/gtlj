    ...
    implements CoordinateSequence, Serializable
{
  ...
  public double getOrdinate(int index, int ordinateIndex)
  {
    switch (ordinateIndex) {
      case X:  return coordinates[index].x;
      case Y:  return coordinates[index].y;
      case Z:  return coordinates[index].z;
    }
    return Double.NaN;
  }
  /**
  ...
  {
    switch (ordinateIndex) {
      case X:  coordinates[index].x = value; break;
      case Y:  coordinates[index].y = value; break;
      case Z:  coordinates[index].z = value; break;
    }
  }
  /**
