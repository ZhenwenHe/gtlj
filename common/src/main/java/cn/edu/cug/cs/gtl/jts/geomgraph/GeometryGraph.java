 ...
 */
package cn.edu.cug.cs.gtl.jts.geomgraph;

import java.util.*;

import cn.edu.cug.cs.gtl.jts.algorithm.BoundaryNodeRule;
import cn.edu.cug.cs.gtl.jts.algorithm.CGAlgorithms;
import cn.edu.cug.cs.gtl.jts.algorithm.LineIntersector;
import cn.edu.cug.cs.gtl.jts.algorithm.PointLocator;
...
import cn.edu.cug.cs.gtl.jts.geomgraph.index.SegmentIntersector;
import cn.edu.cug.cs.gtl.jts.geomgraph.index.SimpleMCSweepLineIntersector;
...
*/
    ...
    /**
     * The lineEdgeMap is a scene of the linestring components of the
