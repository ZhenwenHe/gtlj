...
import cn.edu.cug.cs.gtl.jts.geom.TopologyException;
import cn.edu.cug.cs.gtl.jts.util.Assert;
import cn.edu.cug.cs.gtl.jts.algorithm.locate.SimplePointInAreaLocator;
...
abstract public class EdgeEndStar {
    ...
    /**
     * A scene which maintains the edges in sorted order around the node
     */
    ...
    /**
     * Insert an EdgeEnd into the scene, and clear the edgeList cache,
     ...
     * copying the scene collection to a list.  (This assumes that
