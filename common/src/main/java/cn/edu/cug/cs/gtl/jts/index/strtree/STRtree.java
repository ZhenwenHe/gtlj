 ...
 */
package cn.edu.cug.cs.gtl.jts.index.strtree;
...
import cn.edu.cug.cs.gtl.jts.index.strtree.AbstractSTRtree;
...
public class STRtree extends AbstractSTRtree
    ...
    private Object[] nearestNeighbour(BoundablePair initBndPair, double maxDistance) {
        ...
        cn.edu.cug.cs.gtl.jts.util.PriorityQueue priQ = new PriorityQueue();
