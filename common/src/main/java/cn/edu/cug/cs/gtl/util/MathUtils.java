...
public final class MathUtils {
     ...
     *
     * <p>It is crucial to use different hash fn to partition data across machines and the internal partitioning of
    ...
    /**
     * Bit-mixing for pseudo-randomization of integers (e.g., to guard against bad hash fn). Implementation is
