...
package cn.edu.cug.cs.gtl.jts.planargraph;
...
/**
 * A scene of {@link Node}s, indexed by the coordinate of the node.
 *
 * @version 1.7
 */
public class NodeMap {
    ...
    /**
     * Adds a node to the scene, replacing any that is already at that location.
     *
