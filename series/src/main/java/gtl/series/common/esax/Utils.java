package gtl.series.common.esax;
...
public class Utils {
    ...
    public static int [] esax(double[] ts, long w, int alphabet){
        ...
        double std_value = gtl.series.common.Series.standardDeviation(mean_value, reducedDataY);


        if(std_value > 0 ){
            double[] breakingpoints = gtl.series.common.sax.Utils.saxComputeBreakpoints(alphabet,mean_value,std_value);
            int[] alphabets =  gtl.series.common.sax.Utils.saxGenerateAlphabet(alphabet);
